      ...
      <div className="flex justify-center py-4">
        <div className="rounded border-solid border-2 border-green-500 max-w-sm overflow-hidden shadow-lg">
          <div className="px-6 py-4">
            ...
            <p className="text-base">
              <p>
                毎週寮食堂の小部屋で活動しています、茶道同好会です。今年のお茶会ではコロナ禍ということで昨年に引き続き、例年通りの生菓子ではなくお干菓子をお茶請けとしてお出しいたします。お茶碗ではなく紙コップでの提供となり残念でありますが、ぜひお抹茶を味わってみてください。一席(お茶1杯とお菓子1つ)200円となります。
              </p>
              <p>
